...
controller.create = async (req,res)=>{
   const data = {identificacion, nombre, primer_apellido,segundo_apellido,telefono_contacto,fecha_nacimiento,licencia_conduccion} = req.body;
  ...
  //    return data;
    ...
    conn.query(' CALL sp_insert_author( '+ data + ')',(err, res) => {
      if(err) throw err;
       console.log('Last insert ID:', res.insertId, err)
       return err;
    })
