...
controller.getShipping = (req, res, next) => {
    conn.query('SELECT E.id_envio, E.fecha_inicio, E.fecha_fin, E.valor_envio, V.placa, CO.descripcion as ciudad_origen, CD.descripcion as ciudad_destino, ES.descripcion as estado ' +
